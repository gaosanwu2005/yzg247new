...
use data\api\ICategory;
use data\service\WebSite;
use think;

use data\model\NsSchoolResumeModel;
use data\model\NsSchoolInfoModel;
use data\model\NsCategoryModel;

class Category extends BaseService implements ICategory
{
     ...
     */
    public function getCategoryList($page_index = 1, $page_size = 0, $where = '', $order = '')
    {
        $category_list = new NsCategoryModel();
        $list = $category_list->pageQuery($page_index, $page_size, $where, $order, '*');
        return $list;
    }
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\IShop::addSchoolResume()
     */
