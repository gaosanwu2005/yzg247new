		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装易学佳家</a></li>
					<li role="presentation"><a target = "_blank" href="http://yzg247.new.my">易学佳家官网</a></li>
					<li role="presentation"><a target = "_blank" href="http://yzg247.new.my/forummain.html">访问论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a  target = "_blank" href="http://yzg247.new.my">易学佳家官网</a> &nbsp; &nbsp; <a  target = "_blank" href="http://yzg247.new.my/forummain.html">易学佳家论坛</a> &nbsp; &nbsp; <a target = "_blank" href="http://yzg247.new.my/authorization.html">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a   target = "_blank" href="http://yzg247.new.my"><b>易学佳家</b></a> v1.0 B2C公测版 &copy; 2015-2025 <a target = "_blank" href="http://yzg247.new.my">yzg247.new.my</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2016，易学佳家团队保留所有权利。 </h3>
				<p>
					感谢您选择易学佳家（以下简称NiuShop，NiuShop基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于易学佳家系统(以下简称Niushop)任何版本，易学佳家官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改易学佳家源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在易学佳家的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求易学佳家安装目录下的runtime和upload必须可写, 才能使用易学佳家所有功能。</div>
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<!-- <div class="help-block">
							...
							在线安装能够直接安装最新版本易学佳家系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
...
// 	$themes = get_store_theme();
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“易学佳家”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./index.php">访问网站首页</a>
